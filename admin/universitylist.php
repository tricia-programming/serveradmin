...
<body>
	...
	<tbody>
		...
		$sql = mysqli_query(connect(),"SELECT * FROM university_table order by university_id");
		...
		<tr class="active-row">
                ...
                <td><?php echo $rows['university_email'];?></td>
                <td><?php echo $rows['university_tel'];?></td>
                 
                <td><?php echo $rows['university_address'];?></td>
               

                <td><a class="button" href="universitydelete.php?id=<?php echo $rows['university_id'];?>"><span>DELETE</span></a></td>
            </tr>
	<?php
	}
	?>
